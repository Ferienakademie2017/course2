...
trainConfig = TrainingConfiguration.TrainingConfiguration(NumObsPosX=1, NumObsPosY=10, simPath='data/test_timeStep/', GUI=False,maxObstacleNumber = 5,maxObstacleSize = 0.2,resY = 32,NumSteps=200,timeOffset = 100)
